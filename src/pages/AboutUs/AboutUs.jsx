                     ...
                     <div className="flex items-center -mx-3 sm:-mx-4">
                        <div className="w-full px-3 sm:px-4 xl:w-1/2">
                           <div className="py-3 sm:py-4">
                              <img src="https://cdn.spafinder.com/2020/06/woman-navigating-beauty-products.jpg"
                                 alt="" className="w-full rounded-2xl" />
                           </div>
                           <div className="py-3 sm:py-4">
                              <img src="https://i.imgur.com/1E7s4Cg.jpg"
                                 alt="" className="w-full rounded-2xl" />
                           </div>
                        </div>
                        <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  ...
                  <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                     <div className="mt-10 lg:mt-0">
                        ...
                        <h2 className="mb-5 text-3xl font-bold text-dark dark:text-white sm:text-[40px]/[48px]">
                           Elevate Your Beauty with Cosmico Products
                        </h2>
                        <p className="mb-5 text-base text-body-color dark:text-dark-6">
                           At Cosmico, we are dedicated to making your beauty experience
                           extraordinary. Our carefully curated selection of makeup and beauty
                           products is designed to enhance your natural beauty and elevate your
                           skincare routine.
                        </p>
                        <p className="mb-8 text-base text-body-color dark:text-dark-6">
                           Explore a world of premium cosmetics and skincare essentials that
                           cater to your unique style and beauty needs. Join us on the journey
                           to radiance and self-expression.
                        </p>
                        <a href="/" className="inline-flex items-center justify-center py-3 text-base font-medium text-center text-white border border-transparent rounded-md px-7 bg-primary hover:bg-opacity-90">
                           Explore Our Shop
                        </a>
                     </div>
                  </div>
